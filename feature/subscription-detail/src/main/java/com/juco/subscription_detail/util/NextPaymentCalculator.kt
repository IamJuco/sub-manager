package com.juco.subscription_detail.util

import com.juco.subscription_detail.model.PaymentCalculationResult
...
suspend fun nextPaymentCalculator(
    ...
    PaymentCalculationResult(formattedDate, dDayText)
}